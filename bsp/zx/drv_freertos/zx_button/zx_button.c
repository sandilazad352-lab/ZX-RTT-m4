...
static void zx_button_update_task(void *arg);
...
void zx_button_init(zx_button_config_t* config) {
	...
	if (g_button_config->update_task.en) {
        xTaskCreate(zx_button_update_task, "btn-update", 4 * 1024, NULL, g_button_config->update_task.priority, NULL);
    }
}
