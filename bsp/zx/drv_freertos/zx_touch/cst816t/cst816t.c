...
static ZX_t cst816t_init(const touch_panel_config_t *config) {
    if (config->rst_pin > -1) {
...
static ZX_t cst816t_deinit(void) {
    return ZX_OK;
}

static ZX_t cst816t_read_point_data(touch_panel_points_t *point) {
