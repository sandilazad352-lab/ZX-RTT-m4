...
struct rt_touch_info ft_info =
{
    ...
    1,
    (rt_int32_t)ZX_TOUCH_PANEL_GSL1680_X_RANGE,
    (rt_int32_t)ZX_TOUCH_PANEL_GSL1680_Y_RANGE,
};
...
static int rt_hw_gsl1680_port(void)
{
    ...
    cfg.dev_name = ZX_TOUCH_PANEL_GSL1680_I2C_CHA;
    rst_pin = hal_gpio_name2pin(ZX_TOUCH_PANEL_GSL1680_RST_PIN);
