...
struct aic_pinmux aic_pinmux_config[] = {
    ...
    {5, PIN_PULL_DIS, 3, "PE.15"},
#endif
#ifdef AIC_USING_UART4
    /* uart4 */
    {5, PIN_PULL_DIS, 3, "PE.2"},
    {5, PIN_PULL_DIS, 3, "PE.3"},
#endif
#ifdef AIC_USING_UART5
    /* uart5 */
    {5, PIN_PULL_DIS, 3, "PF.0"},
    {5, PIN_PULL_DIS, 3, "PF.1"},
#endif
#ifdef AIC_USING_UART6
		/* uart6 */
		{5, PIN_PULL_DIS, 3, "PE.6"},
		{5, PIN_PULL_DIS, 3, "PE.7"},
#endif
    ...
    /* can0 */
    {4, PIN_PULL_DIS, 3, "PE.4"},
    {4, PIN_PULL_DIS, 3, "PE.5"},
#endif
    ...
    {1, PIN_PULL_DIS, 3, "PA.10"},  // INT
    {1, PIN_PULL_DIS, 3, "PA.11"},  // RST
#endif
